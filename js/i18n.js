const strings = {
  de: {
    ...
    nameInvalidCharacters: 'Nur Buchstaben und Zahlen – keine Leerzeichen, Satzzeichen oder Emojis.',
  ...
  en: {
    ...
    nameInvalidCharacters: 'Letters and digits only – no spaces, punctuation or emoji.',
